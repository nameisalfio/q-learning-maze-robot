...
class Config:
    ...
    def _get_defaults(self) -> Dict[str, Any]:
        ...
        return {
            'agent': {'learning_rate': 0.12, 'discount_factor': 0.96},
            'strategy': {'name': 'curiosity', 'epsilon': 0.3},
            'environment': {'steps': 200},
            'training': {'episodes': 1000, 'model_path': 'models/q_agent.pkl'}
        }
